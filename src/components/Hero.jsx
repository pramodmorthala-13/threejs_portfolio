...
const Hero = () => {
  ...
  const typedItems = ["ReactJs Developer", "Software Developer", "Senior Software Engineer", "IT Professional", "Team Mentor"];
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">Pramod Morthala</span>
          </h1>

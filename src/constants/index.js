...
const education = [
  {
    title: "M.Tech (Electrical Power Systems",
    company_name: "Shahjehan College of Engineering and Technology -Nyalate Village, Hyderabad, India",
    icon: otu,
    iconBg: "#fff",
    date: "2016",
    points: [
  ...
  {
    title: "B.Tech (Electrical & Electronical Engineering)",
    company_name: "Jayamukhi Institute Of Technological Science",
    icon: rhhs,
    iconBg: "#fff",
    date: "2010-2014",
    points: [
